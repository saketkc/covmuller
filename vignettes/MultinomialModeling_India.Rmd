...
p1 <- BarPlot(state_seq_stats_summary,xaxis = "State", ylabel = "Sequenced per month", color = "slateblue1", label_si = TRUE, xangle = 90, title = "India")
p1
```
...
custom_voc_mapping <- list(
  ...
  `BA.2` = "Omicron-BA.2", `BA.2.10` = "Omicron-BA.2.10"
)
for (omi in omicron) {

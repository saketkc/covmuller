...
BarPlot(india_cases, ylabel = "Cases per month")
```
...
BarPlot(country_seq_stats, ylabel ="Cases sequenced per month")
```
...
india_sequencing_proportion <- CombineSequencedCases(cases_sequenced = country_seq_stats,
                                                     confirmed_long = india_cases_long,
                                                     month.min = "Mar 2020")
BarPlot(india_sequencing_proportion, yaxis = "percent_sequenced_collected")
```

...
the_anim <- PlotVariantPrevalenceAnimated(newyork_cases_pred_prob_sel_long, title = "Estimated cases (weekly average) in New York City by variant", caption = "**Source: gisaid.org and covid19nytimes<br>**")
...
gisaid_NYC <- gisaid_NYC %>% filter(MonthYearCollected > "Oct 2021")
gisaid_weekwise <- SummarizeVariantsWeekwise(gisaid_NYC)
...
gisaid_NYC <- gisaid_NYC %>% filter(MonthYearCollected > "Jan 2022")
gisaid_weekwise <- SummarizeVariantsWeekwise(gisaid_NYC)

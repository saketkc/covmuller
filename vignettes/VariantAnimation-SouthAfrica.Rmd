...
gisaid_sa_subset <- gisaid_sa %>% filter(MonthYearCollected > "April 2023")
...
gganimate::anim_save(filename = here::here("docs/articles/SA_animated_2023.gif"), animation = the_anim)
```
![](SA_animated_2023.gif)

...
the_anim <- PlotVariantPrevalenceAnimated(United_Kingdom_cases_pred_prob_sel_long, title = "Estimated cases (weekly average) in United Kingdom by variant", caption = "**Source: gisaid.org and ourworldindata.org/coronavirus**<br>", date_breaks = "100 days")

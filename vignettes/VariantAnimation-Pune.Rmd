---
title: "Animation of projected weekly cases - Pune (India)"
output:
  html_document:
    df_print: paged
---
...
head(pune_monthly_cases)
```


## Plot monthly cases for Pune


```{r, fig.width=8, fig.height=5, warning=FALSE}
p1 <- BarPlot(pune_monthly_cases, ylabel = "Cases per month", label_si = TRUE, title = "Total cases per month - Pune (India)", caption = "**Source: covid19bharat.org<br>**")
p1
```
...
gisaid_dist <- gisaid_india %>% filter(MonthYearCollected > "Oct 2021")  %>% filter(custom_city == "Pune") %>% arrange(WeekYearCollected)

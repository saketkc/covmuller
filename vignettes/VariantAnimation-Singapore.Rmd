...
gisaid_singapore_subset <- gisaid_singapore %>% filter(MonthYearCollected > "December 2021")
...
gganimate::anim_save(filename = here::here("docs/articles/Singapore_animated_2022.gif"), animation = the_anim)
```
![](Singapore_animated_2022.gif)

---
title: "Animation of projected weekly cases - Kolkata (India)"
output:
  html_document:
    df_print: paged
---
...
gisaid_dist <- gisaid_india %>% filter(MonthYearCollected > "Oct 2021")  %>% filter(custom_city == "Kolkata") %>% arrange(WeekYearCollected)
